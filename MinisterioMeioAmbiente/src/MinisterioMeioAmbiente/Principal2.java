...
public class Principal2 extends javax.swing.JFrame {
     ...
     */
    public Principal2() {
    	setIconImage(Toolkit.getDefaultToolkit().getImage(Principal2.class.getResource("/MinisterioMeioAmbienteImg/aps.png")));
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Leitor de Biometria Nível 3");
        setResizable(false);
    ...
    private void btnCompararActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompararActionPerformed
        ...
        if (iRetorno == 1) {
            ...
            TelaApresentaCadastroProprietarioAgrotoxicoQtd frame = new TelaApresentaCadastroProprietarioAgrotoxicoQtd();
